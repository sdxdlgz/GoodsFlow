      ...
      <div className="mx-auto max-w-6xl">
        <header className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0">
            ...
            <h1 className="mt-2 font-serif text-3xl tracking-tight sm:text-4xl">订单列表</h1>
        ...
        <div className="mt-10 space-y-6">{nickname ? <OrderList nickname={nickname} /> : <NicknameSearch />}</div>
      </div>
    </main>
  );
}
